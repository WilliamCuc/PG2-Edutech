...
urlpatterns = [
    ...
    path('actividad/<int:pk>/editar/', views.ActividadUpdateView.as_view(), name='actividad_update'),
    ...
    path('entrega/<int:pk>/editar/', views.EntregaUpdateView.as_view(), name='entrega_update'),
    path('entrega/<int:pk>/eliminar/', views.EntregaDeleteView.as_view(), name='entrega_delete'),
